// MFOP Specification v1.0 — contenido estructurado para la página de revisión por pares
// Cada sección: { id, title, level (1=h2, 2=h3), content, blocks? }
// blocks: [{ type: 'table', headers: [...], rows: [[...]] } | { type: 'note', content }]

export const mfopMeta = {
  title: 'Protocolo de Federación y Orquestación Mahalaxmi',
  shortTitle: 'MFOP',
  version: '1.0',
  status: 'Borrador para Revisión por Pares',
  date: 'Marzo 2026',
...
Los comentarios y preguntas deben dirigirse a la autora a Ami.nunez@mahalaxmi.ai. El borrador actual y los hilos de discusión se mantienen en https://mahalaxmi.ai/mfop/draft. Los hilos de discusión se encuentran en https://mahalaxmi.ai/mfop/discuss.`,
  },
  {
    ...
    level: 1,
    content: `Copyright © 2026 ThriveTech Services LLC. Todos los derechos reservados. Se otorga permiso para copiar, distribuir y utilizar este documento en cualquier medio sin cargo, siempre que la atribución a la autora, el título del documento y este aviso de derechos de autor se conserven en todas las copias y trabajos derivados.`,
  },
  {
    id: 'abstract',
    title: 'Resumen',
    level: 1,
    content: `Este documento define el Protocolo de Federación y Orquestación Mahalaxmi (MFOP), un protocolo para coordinar la ejecución paralela de agentes de IA a través de una red distribuida de nodos de cómputo heterogéneos. MFOP especifica la identidad y el registro de nodos, la publicación de capacidades, el enrutamiento de trabajos consciente de zonas de cumplimiento, la partición semántica de entradas, los recibos de facturación firmados criptográficamente, la liquidación económica configurable y un modelo de seguridad por capas que utiliza validación de políticas de seguridad de IA y aislamiento en entornos de ejecución controlados.
...
MFOP está diseñado para operar en tres configuraciones de despliegue simultáneas: mallas empresariales privadas donde los nodos son propiedad y están operados por una sola organización, grupos de nube administrados por el proveedor de la plataforma, y mercados comunitarios abiertos donde cualquier operador de nodos puede contribuir cómputo a cambio de liquidación económica. El protocolo es agnóstico al proveedor de modelos de IA subyacente y está diseñado para evolucionar con el panorama de seguridad y cumplimiento de la IA.`,
  },
  {
    ...
    level: 1,
    content: `El crecimiento de los despliegues de modelos de lenguaje de gran escala (LLM) en entornos empresariales ha creado la necesidad de una capa de coordinación capaz de abarcar infraestructura de cómputo heterogénea mientras satisface requisitos de cumplimiento, facturación y seguridad que varían según la jurisdicción y el sector.
...
Esta especificación define el protocolo de comunicación, los formatos de datos, los mecanismos criptográficos y los requisitos de comportamiento para todos los componentes de una federación MFOP conforme.`,
  ...
  {
    id: 'section-2',
    title: '2. Terminología',
    level: 1,
    content: `Las palabras clave "DEBE", "NO DEBE", "REQUERIDO", "DEBERÁ", "NO DEBERÁ", "DEBERÍA", "NO DEBERÍA", "RECOMENDADO", "NO RECOMENDADO", "PUEDE" y "OPCIONAL" en este documento DEBEN interpretarse según lo descrito en BCP 14 [RFC2119] [RFC8174].
...
**NeMo Guardrails** — El framework de seguridad NVIDIA NeMo utilizado por los nodos MFOP para la validación de políticas de seguridad de IA y el filtrado de salidas.`,
  ...
  {
    id: 'section-3',
    title: '3. Identidad y Registro de Nodos',
    level: 1,
    content: `Cada nodo en una federación MFOP se identifica mediante un identificador de nodo estable y globalmente único (node_id). El node_id es un UUID de 128 bits (versión 4) asignado en el momento del registro y persiste a través de reinicios del nodo y actualizaciones de software.
...
Los nodos DEBEN enviar un latido a POST /v1/federation/nodes/{id}/heartbeat al menos una vez cada 60 segundos. Un nodo que omita tres ventanas consecutivas de latido se marca como INACTIVO y se excluye del enrutamiento. Los nodos pueden cancelar su registro voluntariamente mediante DELETE /v1/federation/nodes/{id}.`,
  ...
  {
    id: 'section-4',
    title: '4. Publicación de Capacidades',
    level: 1,
    content: `La publicación de capacidades de un nodo declara los modelos de IA disponibles en el nodo, las características de hardware relevantes para el enrutamiento de trabajos y las certificaciones de cumplimiento que posee el operador del nodo.
...
Los nodos DEBEN actualizar su publicación de capacidades mediante PUT /v1/federation/nodes/{id}/capabilities siempre que cambien sus modelos disponibles o la configuración de hardware. La federación propaga las publicaciones de capacidades actualizadas a la capa de enrutamiento en un plazo de 30 segundos.`,
  ...
  {
    id: 'section-5',
    title: '5. Enrutamiento de Trabajos Consciente de Zonas de Cumplimiento',
    level: 1,
    content: `MFOP enruta cada trabajo a un nodo que satisface los requisitos de zona de cumplimiento del trabajo. La satisfacción de la zona de cumplimiento es una restricción estricta: un trabajo NO DEBE enrutarse a un nodo que no esté certificado para la zona de cumplimiento del trabajo.
...
Las reglas de afinidad afectan únicamente al componente puntuación_afinidad; la certificación de zona de cumplimiento y la capacidad permanecen como restricciones estrictas.`,
  ...
  {
    id: 'section-6',
    title: '6. Partición Semántica de Entradas',
    level: 1,
    content: `Para trabajos cuya entrada supera el max_context_tokens de un único nodo, MFOP proporciona un mecanismo de partición semántica que divide la entrada en sub-trabajos coherentes, enruta cada sub-trabajo de forma independiente y agrega los resultados.
...
Una vez que todos los sub-trabajos se completan, la capa de agregación de la federación ensambla los resultados en orden de número de secuencia. Para las particiones sliding_window, el agregador elimina duplicados del contenido en las regiones de superposición utilizando una fusión de subsecuencia común más larga. El resultado ensamblado se devuelve al emisor como un único JobResult con una lista de sub_job_receipts.`,
  ...
  {
    id: 'section-7',
    title: '7. Recibos de Facturación Firmados Criptográficamente',
    level: 1,
    content: `Cada ejecución de trabajo completada produce un BillingReceipt firmado por el nodo ejecutor. Los recibos firmados son el registro autoritativo para la liquidación económica y la resolución de disputas.
...
La federación almacena todos los recibos por un mínimo de 7 años para satisfacer los requisitos de auditoría de cumplimiento. Los emisores pueden recuperar sus recibos mediante GET /v1/federation/receipts. Los operadores de nodos pueden recuperar los recibos de los trabajos que ejecutaron mediante GET /v1/federation/nodes/{id}/receipts.`,
  ...
  {
    id: 'section-8',
    title: '8. Liquidación Económica Configurable',
    level: 1,
    content: `MFOP separa la facturación (la acumulación de recibos firmados) de la liquidación (la transferencia financiera de fondos). La liquidación es configurable y puede ocurrir en distintos calendarios para diferentes tipos de participantes.
...
Los operadores de nodos reciben sus pagos mediante Stripe Connect al final de cada período de liquidación, siempre que sus ganancias acumuladas superen el umbral minimum_payout_usd. Los operadores que no alcanzan el umbral trasladan sus ganancias al período siguiente.`,
  },
  {
    ...
    level: 1,
    content: `MFOP implementa un modelo de seguridad de tres capas: seguridad de transporte, validación de políticas de seguridad de IA y aislamiento en entornos de ejecución controlados.
...
Todas las decisiones de enrutamiento de trabajos, firmas de recibos y eventos de liquidación se escriben en un registro de auditoría de solo anexo. El registro de auditoría está encadenado criptográficamente usando hashes SHA-256 (cada entrada incluye el hash de la entrada anterior). El registro de auditoría no puede modificarse; solo se permiten operaciones de anexado.`,
  ...
  {
    id: 'section-10',
    title: '10. Protocolo de Comunicación',
    level: 1,
    content: `MFOP utiliza JSON sobre HTTPS para toda la comunicación de la API. Las conexiones WebSocket son compatibles para la transmisión en flujo de salida de trabajos (ver Sección 10.2).
...
Las solicitudes de envío de trabajos DEBERÍAN incluir un encabezado Idempotency-Key (UUID). Si se recibe una solicitud con la misma Idempotency-Key dentro de la ventana de idempotencia (24 horas), la federación devuelve la respuesta original sin volver a ejecutar el trabajo. Esto protege contra envíos duplicados causados por reintentos de red.`,
  ...
  {
    id: 'appendix-a',
    title: 'Apéndice A. Referencia de la API REST',
    level: 1,
    content: `Este apéndice lista los endpoints de la API REST de MFOP. Todos los endpoints requieren un encabezado X-Channel-API-Key salvo que se indique lo contrario. Ruta base: /v1/federation`,
    blocks: [
      {
        type: 'table',
        headers: ['Método + Ruta', 'Nombre', 'Descripción'],
        rows: [
  ...
  {
    id: 'appendix-b',
    title: 'Apéndice B. Requisitos de Políticas por Zona de Cumplimiento',
    level: 1,
    content: `Cada zona de cumplimiento requiere capacidades específicas de políticas de NeMo Guardrails más allá de la referencia. La siguiente tabla resume los rieles mínimos requeridos por zona.`,
    blocks: [
      {
        type: 'table',
        headers: ['Zona', 'Rieles Requeridos Además de la Referencia'],
        rows: [
